...
/// Talks to the shared ShareCab backend at `${ApiConfig.apiRoot}/auth/*`.
/// In production, phone login uses [Msg91AuthApi]; these endpoints are the
/// dev-fallback path (server-sent OTP, only enabled when the backend has
/// `MSG91_DEV_FALLBACK=true`).
