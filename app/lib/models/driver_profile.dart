...
class DriverSubscription {
  ...
  bool get isFreeTrial => paymentRef == 'free-trial' || paymentRef == 'free-trial-backfill';
...
/// Full driver-side profile used by [DriverHomeScreen]. Mirrors the backend
/// `GET /api/drivers/me` response.
class DriverProfile {
  final String id;
  final String userId;
...
/// Same logic [HttpRideApi._vehicleTypeFromCapacity] uses — kept inline so
/// this file doesn't depend on the rider api wiring.
